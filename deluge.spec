...
Source0:	http://download.deluge-torrent.info/pub/deluge/source/%{name}-%{version}_%{_rc}.tar.lzma
# Source0-md5:	197bd2fdd83fd2d03ca41031d8767456
...
Requires:	python-libtorrent-rasterbar >= 0.14.5
